...
to criarAgentes
  set-default-shape peixes "fish 3"
  create-peixes numero-peixes [
    setxy random-pxcor random-pycor
    set size 3
    set color one-of remove blue base-colors
  ]
  set-default-shape tubaroes "shark"
  create-tubaroes numero-tubaroes [
    set size 7
    setxy random-pxcor random-pycor
    set color grey
  ]
...
to criarCenario
ask patches [
    set pcolor blue + (random-float 0.5) - 0.2
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
